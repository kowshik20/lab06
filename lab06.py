...
dataframe=pd.read_csv(r"C:\Users\ril\Downloads\palm_document_Gabor.csv")
dataframe
...
dataframe=dataframe.drop(columns=['ImageName'])
dataframe
...
plt.scatter(dataframe.Theta0_Lambda0_LocalEnergy,dataframe.Theta0_Lambda0_MeanAmplitude)
